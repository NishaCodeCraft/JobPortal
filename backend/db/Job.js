...
let schema = new mongoose.Schema(
  {
    ...
    location: {
      type: String, // You can change the data type to match your location data structure (e.g., String, Object, etc.)
      required: true, // You can make it required if location is essential for each job
    },
    rating: {
      type: Number,
      max: 5.0,
